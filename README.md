...
- Генерація мовлення через Google Cloud TTS (uk-UA-Wavenet-A, 24 kHz)
...
- Підтримка української мови (нативний голос Wavenet)
...
├── tts_client.c/.h     — Google Cloud TTS (текст → мовлення, uk-UA-Wavenet-A)
└── Kconfig.projbuild   — menuconfig опції (WiFi, API keys)
```
